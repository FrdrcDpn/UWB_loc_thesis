...
class LogFlight():
    ...
    def build_trajectory(self, trajectories, space):
        ...
        for trajectory in trajectories:
            ...
            elif trajectory == "tinysquare":
                setpoints += tinysquare(home["x"]-0.5, home["y"]-0.5, 1, altitude)
        ...
        try:
            ...
            # Do actual flight
                ...
                for i, point in enumerate(setpoints):
                    ...
                    # first fly to first setpoint. If we arrived there, ask to continue and start ranging
