...
def tinysquare(x0, y0, side_length, altitude):
    setpoints = tinyxy_square(x0, y0, side_length, altitude, 0.0)
    return setpoints

def square1(x0, y0, side_length, altitude):
    setpoints = xy_square1(x0, y0, side_length, altitude, 0.0)
    return setpoints

def square2(x0, y0, side_length, altitude):
    setpoints = xy_square2(x0, y0, side_length, altitude, 0.0)
    return setpoints

def square3(x0, y0, side_length, altitude):
    setpoints = xy_square3(x0, y0, side_length, altitude, 0.0)
    return setpoints
